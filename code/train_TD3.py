...
class Train_TD3():
    def __init__(self,parameters,train_gui):
        ...
        self.filename = os.path.join(self.output_folder, 'TD3_save-'+datetime.now().strftime("%m.%d.%Y_%H.%M.%S"))
    ...
    def train_TD3(self):
        ...
        """"
        model = TD3.load("results/SAC_save-12.24.2024_18.07.36/final_model.zip",train_env)
        """
        model = TD3('MultiInputPolicy',train_env,
